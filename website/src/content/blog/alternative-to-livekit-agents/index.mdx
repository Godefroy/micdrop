...
summary: 'Micdrop runs a voice call in TypeScript over a WebSocket to your own Node server. LiveKit Agents works in Node too, as a worker that joins a WebRTC room.'
date: 2026-08-13
author: godefroy
image: ./thumbnail.jpg
keywords:
...
| Realtime model plugin passed as `llm` | [`realtime` option](/docs/server/realtime) |
...
| **Speech-to-speech models** | OpenAI Realtime, Gemini Live and several others | OpenAI Realtime and Gemini Live |
