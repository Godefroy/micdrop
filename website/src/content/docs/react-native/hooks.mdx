...
- [React hooks](/docs/client/react-hooks) for `useMicdropState`, `useMicdropError`, `useMicdropEndCall`, `useMicdropToolCall`, `useMicdropClassification`, `useMicVolume` and `useSpeakerVolume`
