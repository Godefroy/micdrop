...
`agent` and `tts` are optional. A server given a speech to text alone
transcribes and stays quiet, which is all a dictation tool needs. One given an
agent and no voice answers in writing.
...
- **[Agent](../ai-integration/custom-integrations/custom-agent)** - AI agent base class and implementations, optional
- **[STT](../ai-integration/custom-integrations/custom-stt)** - Speech-to-text base class and implementations
- **[TTS](../ai-integration/custom-integrations/custom-tts)** - Text-to-speech base class and implementations, optional
- **[Realtime](./realtime)** - Speech-to-speech models, in place of the three above
- **[Classifier](./classifier)**, typed decisions about what the user says, optional
