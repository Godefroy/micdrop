...
which runs [Jev](../ai-integration/provided-integrations/typesafe), the System
One model of TypeSafe. Any other model fits by extending the
...
The demos that run on a classifier are listed with the other examples, in
