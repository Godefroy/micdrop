...
Cartesia, Gradium, OpenAI and the local engines are all [alternatives to ElevenLabs](/blog/elevenlabs-alternatives-typescript) that you can put in the provider list.
