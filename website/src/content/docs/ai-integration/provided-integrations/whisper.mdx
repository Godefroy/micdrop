...
second one. Only the decoding scales with what is being said. Moonshine and
Parakeet read audio at its real length and [run in Node through
sherpa-onnx](/blog/local-speech-to-text-node).
