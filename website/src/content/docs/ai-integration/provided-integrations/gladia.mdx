---
title: 'Gladia'
description: 'Transcribe a live call in your Node server using Gladia streaming speech to text. One npm package and an API key wire it into a TypeScript voice pipeline.'
order: 49
---
...
See the [types file](https://github.com/Godefroy/micdrop/blob/main/packages/gladia/src/types.ts) for the complete list of supported language codes.
