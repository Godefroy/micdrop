...
Gemini 3.8 Live costs about a quarter of GPT-Realtime-2.1 per minute. It also
[differs from OpenAI's realtime models in session length and reasoning](/blog/gpt-live-vs-gpt-realtime-vs-gemini-live).
