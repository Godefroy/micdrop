...
To hear Micdrop work, start with the
[basic example](https://github.com/Godefroy/micdrop/tree/main/examples/basic).
Every other example app and demo, with the command that runs it, is listed in
